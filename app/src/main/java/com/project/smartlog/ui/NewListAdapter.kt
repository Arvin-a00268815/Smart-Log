        ...
        when(getItemViewType(position)) {
            ...
            1 -> {
                ...
                logEntryViewHolder.moreActionView.setOnClickListener {
                    ...
                    inflater.inflate(com.project.smartlog.R.menu.menu_log, popup.menu)
                    popup.show()
                    popup.setOnMenuItemClickListener(object : PopupMenu.OnMenuItemClickListener {
                        override fun onMenuItemClick(item: MenuItem): Boolean {
                            when (item.itemId) {

                                com.project.smartlog.R.id.edit -> {
                                    actionsListener?.edit(logEntry, logEntryViewHolder.adapterPosition)
                                }


                                com.project.smartlog.R.id.delete -> {
                                    actionsListener?.delete(logEntry, logEntryViewHolder.adapterPosition)
                                }

                                com.project.smartlog.R.id.move -> {
                ...
                logBookViewHolder.moreActionView.setOnClickListener {
                    ...
                    val inflater = popup.menuInflater
                    inflater.inflate(com.project.smartlog.R.menu.menu_book, popup.menu)
                    popup.show()
                    popup.setOnMenuItemClickListener(object : PopupMenu.OnMenuItemClickListener {
                        override fun onMenuItemClick(item: MenuItem): Boolean {
                            when (item.itemId) {
                                ...
                                com.project.smartlog.R.id.save_pdf -> {
